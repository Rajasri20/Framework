...
public class ApathePoi_DotXLS_ReadExcel_GetEntireTestData_PlacedDifferently {
	
	/* REQUIREMENT
	 * 
	 *  ".xls" Format, OLDER VERSION OF 97-2003 EXCEL
	 *  
	 *  SAME AS NEW VERSION BUT ONLY THE EXTENTO ".XLS"
	 *  
	 *  
	...
	public void read() throws Exception {
		File file = new File("D:\\TestDataDifferentlyPlaced.xls");
