...
public class Jva_Collections_Map_TreeMap_T {
...
/*2. Map Interface */
		...
		// Displays in Structured order or Alphabetical Order based on KEY only 
		...
		// In place of TreeMap we can write HashTableMap, same concept as TreeMap
		...
		// // Displays in Structured order or Alphabetical Order based on KEY only, 
		// {FirstName=Srikrishna, Password=Admin123, TestScriptName=TC_001, UserName=Admin}
		...
		// // Displays in Structured order or Alphabetical Order based on KEY only, 
		// {Password=Admin123, TestScriptName=TC_001, UserName=Admin}
