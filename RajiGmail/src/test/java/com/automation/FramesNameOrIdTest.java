...
//frame with 'stringNameOrId', hit ctrl space bar, will see this option

public class FramesNameOrIdTest {
public static void main(String[] args) throws Exception{
		...
		driver.switchTo().frame("packageListFrame"); // frame with 'stringNameOrId', hit ctrl space bar, will see this option
