...
public class TstNG_TC_001_AddEmp_AtBforeMethod_AtAftrMethod {
	
	/* Along first 3 Annotations there 2 more "@" Annotations are there, 
	 * these are DEFINED by "TestNG", they are 
	 * "@BeforeMethod and @AfterMethod", 
	 * See sequence below,
	 *   
	 *  1. @BeforeTest .... for OpenBrowser
	 *  2. @BeforeMethod ..... For Login
	 *  3. @Test .... for AddEmployee
	 *  4. @AfterMethod ....for Logout
	 *  5. @AfterTest .... for CloseBrowser
	 *  
	 ...
	 *  
	 *  Define SEPARATE METHODS FOR "Login" AND "Logout"
	 *   
	 *   The Program will EXECUTE in the above order, 
	 *   click ctrl O, 5 METHODS will be displayed */
