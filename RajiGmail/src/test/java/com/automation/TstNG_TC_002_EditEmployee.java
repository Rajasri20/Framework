...
public class TstNG_TC_002_EditEmployee {
	...
	public void editEmployee() throws Exception {
		...
		// Find the control to click on SEARCH BUTTON
		
		driver.findElement(By.linkText("Srikrishna")).click();
		
		// Now find the control for "displayed Name"(Which we searched for "Srikrishna A")
		// And Clicks on it.
