...
public class TstNG_TC_004_AddRemoveCart_SamescrptOnMultiCrossBrowser_SqntialExe {
	
	/* HOW TO RUN SAME SCRIPT ON "MULTI BROWSERS OR DIFFERENT OR CROSS BROWSERS
	 * CROSS BROWSER COMPATABILITY"?
	 * 
	 * Which is also CALLED as "SEQUENTIAL eXECUTION, MEANING SAME SCRIPT IS EXECUTED 
	 * ON DIFFERENT BROWSER ONE BY ONE"
	 * 
	 * Got "tesng.xml" file COPY the TC_004 file and PASTE MULTIPLE TIMES.
	 * Go to <test> tag,
	 * NAME of the <test> tag MUST BE UNIQUE, now CHANGE the NAME, 
	 * at the END of the "TC_004" just ADD the BROWSER's 1st Letter, 
	 * on which you are going to RUN the SCRIPT 
	 * 
	 * SEE BELOW FOR EXAMPLE
	 * 
	 * MULTI BROWSER TAG IN "testng.xml"
	 * 
