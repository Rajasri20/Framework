...
public class DrpDnGetAlSeleOpTest {
	...
	public static void main(String[] args) throws Exception {
		...
		List<WebElement> listref = selectRef.getAllSelectedOptions(); 
		// Type Get and hit Ctrl Space bar, 
		// in the pop up along with GetAllSelected Options method you will see List<WebElement>, 
